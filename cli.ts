...
program.command('payments:create')
...
program.command('payments:find-all')
...
program.command('withdrawals-jobs:consume')
...
program.command('withdrawals-jobs:consume-worker')
...
program.command('withdrawals-jobs:find')
...
program.command('withdrawals-jobs:find-all')
